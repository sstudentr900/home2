## 錯誤訊息語系設定
config/app.php<br>
timezone 改成 Asia/Taipei(台北時間)<br>
locale 改成 zh-TW(繁體中文) ,多國語言不改
```php
    return [
        //時區
...
語系檔案設定都放在resources/lang/目錄中
![Imgur](https://imgur.com/gkHzkKI)
...
欄位名稱修改在resources/lang/zh-TW/validation.php的最後面attributes的地方修改如下:
```php
    <?php
    return [
        'attributes' => [
...
```
![Imgur](https://imgur.com/JMZDqIE)


----
[錯誤訊息語系設定](https://dotblogs.com.tw/SmallFish/2020/10/05/072229)<br>